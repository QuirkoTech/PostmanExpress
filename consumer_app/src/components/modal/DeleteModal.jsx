    ...
    return (
        ...
        <Overlay onClose={closeModal} isOpen={isOpen}>
            ...
            <div
                ...
                className=" bg-dark-secondary border-slate-blue rounded-max sm-max:text-base sm-max:p-4 sm-max:w-11/12 mx-auto h-fit xl-max:w-9/12 w-[56rem] border-2 p-7 text-lg"
            >
                ...
                <label
                    htmlFor="check-box"
                    className="sm-max:pl-7 sm-max:white relative cursor-pointer pl-11"
                >
                    <input
                        type="checkbox"
                        id="check-box"
                ...
                <div className="mx-10 mt-10 sm-max:mt-6 sm-max:mx-3 flex justify-around">
                    <button
                        onClick={closeModal}
