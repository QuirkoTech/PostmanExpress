      ...
      <div className="max-container flex flex-col">
        <div className="grid grid-cols-2 gap-x-20">
          {ActiveParcel.map((parcel) => (
            <div
              key={parcel.id}
              className="w-[440px] h-[116px] bg-dark-secondary py-5 px-5 rounded-2xl mb-10 shadow-lg shadow-black/40 cursor-pointer border-2 border-solid border-transparent hover:border-slate-blue"
                ...
                <div className="flex flex-col items-start">
                  ...
                  <span className="flex flex-row items-center">
                    <div
                      ...
                      style={{ backgroundColor: colorMapping[parcel.status] }}
                    ></div>
